...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(ViewerOptions, description="Dump npz files script", allow_abbrev=False)
    ...
    if dataset_type == DatasetType.ScalarFlow:
        ...
        scalarflow.network_viewer(source_path, mp, op, pp, args.start_checkpoint)

...
class MyParticleNetwork(torch.nn.Module):
    ...
    def __init__(
        ...
        self.conv0_obstacle = Conv(name="conv0_obstacle",
                                   ...
                                   filters=self.layer_channels[0],
                                   activation=None)
        self.dense0_fluid = torch.nn.Linear(in_features=feats_channels,
    ...
    def compute_correction(self,
        ...
        fluid_feats = [torch.ones_like(pos[:, 0:1]), other_feats]
    ...
    def forward(self, inputs):
        ...
        """
        pos, feats, box, box_feats = inputs

        pos_correction = self.compute_correction(pos, feats, box, box_feats)

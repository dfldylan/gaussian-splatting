...
class GaussianFrame:
    ...
    def construct_list_of_attributes(self, is_trans=False):
        if is_trans == True:
    ...
    def save_ply_trans(self, path):
        ...
        dtype_full = [(attribute, 'f4') for attribute in self.construct_list_of_attributes(is_trans=True)]
